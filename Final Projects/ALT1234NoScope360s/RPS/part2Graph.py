...
try:
    ...
    while True:
        ...
        try:
            ...
            # Graph Player Stuff
            bar_chart = pygal.Bar(title=u'PLayer Guesses')                                            # Then create a bar graph object
            bar_chart.add('Rock', playerRockCounter)
            bar_chart.add('Paper', playerPaperCounter)
            bar_chart.add('Scissors', playerScissorsCounter)
            bar_chart.render_to_file('player_guesses.svg')                          # Save the svg to a file
            ...
            # Graph Player Stuff
            bar_chart = pygal.Bar(title=u'Computer Guesses')                                            # Then create a bar graph object
